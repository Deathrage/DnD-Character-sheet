...
/** The three modifiers (spec §3.3), v2's weapon and spell attack bonuses, and v3's initiative. */
...
// These object schemas are `.strict()`, like every object schema in v3 — see the file-level
