...
describe('createCharacter', () => {
  it('produces a document that passes the v3 schema', () => {
    const result = characterDocumentV3Schema.safeParse(createCharacter(INPUT));
  ...
  describe('does not share substructure between documents', () => {
    ...
    const cases: Array<{
      name: string;
      mutate: (doc: CharacterDocumentV3) => void;
      read: (doc: CharacterDocumentV3) => unknown;
      original: unknown;
    }> = [
      {
