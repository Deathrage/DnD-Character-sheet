...
export const characterDocumentV2Schema = documentShape.strict().superRefine((doc, ctx) => {
...
export type CharacterDocumentV2 = z.infer<typeof characterDocumentV2Schema>;
